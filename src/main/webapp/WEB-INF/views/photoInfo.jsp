...
<div class="top_level">
  <div class="content">
    <div class="page_header">Редактирование фотографии:
      <a href="<%=application.getContextPath() %>/photo_${photo.photoId}.html">${photo.title}</a>
    </div>
    <table class="main">
      <colgroup>
      ...
      <tr>
        <td>Превьюшка:</td>
        <td class="photo">
          <img src="<%=application.getContextPath() %>/photo_${photo.photoId}/size_150/show.html" alt="${photo.title}" border="0" />
        </td>
      </tr>
      <tr>
        <td>Название:</td>
