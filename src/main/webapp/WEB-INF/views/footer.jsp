  ...
  <tr>
    <td style="margin:0px; padding:1px;">
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td style="width:100%; height:50px; background-color:#ffffff; text-align:right;">&nbsp; unknown designers, 2008 &nbsp;</td>
        </tr>
      </table>
    </td>
  </tr>
